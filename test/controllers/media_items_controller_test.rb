...
class MediaItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create media_item" do
    assert_difference('MediaItem.count') do
      post media_items_url, params: { media_item: { description: @media_item.description, id: @media_item.id, name: @media_item.name, source: @media_item.source, url: @media_item.url } }
    end
  ...
  test "should update media_item" do
    patch media_item_url(@media_item), params: { media_item: { description: @media_item.description, id: @media_item.id, name: @media_item.name, source: @media_item.source, url: @media_item.url } }
